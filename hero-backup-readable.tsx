...
export default function Hero() {
  return (
    <section className="relative min-h-svh overflow-hidden bg-[#EDE5DA]">
      ...
      {/* ===== LAYER 2: DISTANT HILLS ΓÇö slow drift ===== */}
      ...
      {/* ===== LAYER 3: HEDGE WALL ΓÇö gentle sway ===== */}
      ...
      {/* ===== LAYER 4: TREES ΓÇö each independently animated ===== */}

      {/* Tree 1 ΓÇö tall center-right */}
      <div className="absolute top-0 left-0 w-full h-full hero-tree-1">
        <svg viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" className="w-full h-full">
          <rect x="848" y="200" width="10" height="500" rx="5" fill="#8A8070" />
      ...
      {/* Tree 2 ΓÇö shorter right */}
      <div className="absolute top-0 left-0 w-full h-full hero-tree-2">
        <svg viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" className="w-full h-full">
          <rect x="1048" y="280" width="8" height="420" rx="4" fill="#8A8070" />
      ...
      {/* Orange fruit tree ΓÇö far right */}
      ...
      {/* ===== LAYER 5: MID FOLIAGE HILLS ΓÇö parallax drift ===== */}
      ...
      {/* ===== LAYER 6: DENSE FOREGROUND ΓÇö slow wave ===== */}
      ...
      {/* ===== LAYER 7b: EDGE LEAVES ΓÇö right ===== */}
      ...
      {/* ===== LAYER 9: FLOATING PARTICLES ΓÇö leaves drifting ===== */}
      ...
      {/* ===== HERO CONTENT ===== */}
      <div className="relative z-10 max-w-[1200px] mx-auto px-5 sm:px-8 lg:px-10 min-h-svh flex items-end pb-20 sm:pb-28 lg:pb-32 pt-28">
        <div className="max-w-[540px]">
          <h1 className="hero-animate font-serif text-[36px] sm:text-[48px] lg:text-[60px] font-medium text-brown-900 leading-[1.1] tracking-[-0.02em] mb-5">
            Transparent Legal Services for Indian Founders.
          </h1>
          <p className="hero-animate hero-animate-delay-2 text-[15px] sm:text-[17px] text-brown-600 leading-[1.7] mb-8 max-w-[420px]">
            Incorporate your Pvt Ltd, manage compliance, and file
            returns  with clear fee separation and no hidden costs.
          </p>
          <div className="hero-animate hero-animate-delay-3">
            <a
              href="#contact"
              className="inline-flex items-center px-7 py-3 bg-olive-600 text-white text-[14px] font-semibold rounded-full hover:bg-olive-700 transition-colors duration-200 shadow-lg shadow-olive-600/20"
            >
              Request Demo
            </a>
          </div>
