...
export default function Hero() {
  return (
    <section className="relative min-h-[100svh] overflow-hidden bg-[#EDE5DA]">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#EDE5DA]/75 via-[#EDE5DA]/30 to-transparent pointer-events-none" />
      <div className="absolute inset-0 bg-gradient-to-t from-[#2A3A16]/15 via-transparent to-transparent pointer-events-none" />

      {/* ===== HERO CONTENT ===== */}
      <div className="relative z-10 max-w-[1200px] mx-auto px-5 sm:px-8 lg:px-10 min-h-[100svh] flex items-end pb-20 sm:pb-28 lg:pb-32 pt-28">
