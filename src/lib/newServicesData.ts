...
export const newServicePages: NewServicePage[] = [
  ...
  // ══════════════════════════════════════════════════
  {
    ...
    relatedLinks: [
      ...
      { name: "Sole Proprietorship", href: "/services/sole-proprietorship-registration" },
    ],
    subServices: [
      { name: "Pvt Ltd Company Incorporation", href: "/services/company-incorporation", description: "The most investor-friendly structure. Enables equity funding, ESOPs, and unlimited shareholder scalability.", price: "Market ₹999–₹23,000 · Member Rate" },
      { name: "LLP Registration", href: "/services/llp-registration", description: "Professional firms and co-founder teams who want liability protection without the full weight of corporate compliance.", price: "Market ₹5,000–₹20,000 · Member Rate" },
      { name: "OPC Registration", href: "/services/opc-registration", description: "A one-person company with the full liability shield of corporate structure — ideal for solo founders not ready to take on co-founders.", price: "Market ₹5,000–₹15,000 · Member Rate" },
      { name: "Partnership Firm Registration", href: "/services/partnership-firm-registration", description: "Simple, flexible structure for professional services, trading, and family businesses. Partners share profits under a registered deed.", price: "Market ₹999–₹5,000 · Member Rate" },
      { name: "Sole Proprietorship Registration", href: "/services/sole-proprietorship-registration", description: "The fastest, lowest-cost way to open a business bank account and start trading legally under your own name.", price: "Market ₹499–₹1,999 · Member Rate" },
    ],
  },
  ...
  // ══════════════════════════════════════════════════
  {
    ...
    relatedLinks: [
      { name: "GST Return Filing", href: "/services/gst-indirect-tax" },
      { name: "Business Incorporation", href: "/services/business-incorporation" },
      { name: "Income Tax Advisory", href: "/services/income-tax-advisory" },
    ],
    subServices: [
      { name: "GST Registration", href: "/services/gst-registration", description: "Mandatory for most businesses above ₹20L turnover. Required before raising a single GST-compliant invoice.", price: "Market ₹499–₹1,999 · Member Rate" },
      { name: "UDYAM / MSME Registration", href: "/services/msme-registration", description: "Unlocks priority lending, lower interest rates, government scheme eligibility, and trademark fee discounts.", price: "Market ₹999–₹3,499 · Member Rate" },
      { name: "IEC (Import Export Code)", href: "/services/iec-registration", description: "Mandatory for any business importing or exporting goods from India. Issued by DGFT — lifetime validity.", price: "Market ₹999 · Member Rate" },
      { name: "Labour License", href: "/services/labour-license", description: "Required under various state and central labour laws for businesses engaging contract labour.", price: "Market ₹1,500 · Member Rate" },
      { name: "FSSAI Food License (State)", href: "/services/fssai-state-license", description: "For food businesses with turnover between ₹12 lakh and ₹20 crore operating within one state.", price: "Market ₹1,999 · Member Rate" },
      { name: "FSSAI Food License (Central)", href: "/services/fssai-central-license", description: "For large food businesses, multi-state operations, and importers/exporters of food products.", price: "Market ₹10,000 · Member Rate" },
    ],
  },
  ...
  // ══════════════════════════════════════════════════
  {
    ...
    relatedLinks: [
      { name: "Income Tax Filing & Advisory", href: "/services/income-tax-advisory" },
      { name: "Audit & Attestation", href: "/services/audit-attestation" },
      { name: "GST Registration", href: "/services/gst-registration" },
    ],
    subServices: [
      { name: "Monthly GST Return Filing", href: "/services/gst-monthly-returns", description: "GSTR-1 + GSTR-3B filed monthly with ITC reconciliation. Never miss a date.", price: "Market ₹799–₹2,999/mo · Member Rate" },
      { name: "Quarterly GST Return Filing", href: "/services/gst-quarterly-returns", description: "For businesses under the QRMP scheme — quarterly GSTR-1 with monthly GSTR-3B (PMT-06).", price: "Market ₹1,499–₹1,500/qtr · Member Rate" },
      { name: "Annual GST Return (GSTR-9)", href: "/services/gstr9-annual-return", description: "Comprehensive annual return reconciling all supplies, ITC, and taxes paid during the year.", price: "Market ₹3,000–₹4,999 · Member Rate" },
      { name: "TDS Return Filing", href: "/services/tds-return-filing", description: "Quarterly TDS returns (Form 24Q, 26Q, 27Q) filed accurately with PAN-wise deductee details.", price: "Market ₹2,000–₹3,500 · Member Rate" },
      { name: "GST Audit Execution (GSTR-9C)", href: "/services/gst-audit", description: "CA-certified GSTR-9C for turnovers above ₹5 crore — reconciliation statement with auditor signature.", price: "Market ₹5,000–₹9,999 · Member Rate" },
    ],
  },
  ...
  // ══════════════════════════════════════════════════
  {
    ...
    relatedLinks: [
      { name: "GST & Indirect Tax", href: "/services/gst-indirect-tax" },
      { name: "Audit & Attestation", href: "/services/audit-attestation" },
    ],
    subServices: [
      { name: "Salary ITR Filing", href: "/services/salary-itr-filing", description: "For salaried employees, pensioners, and individuals with interest income, HRA claims, and basic capital gains.", price: "Market ₹499–₹500 · Member Rate" },
      { name: "Business ITR Filing", href: "/services/business-itr-filing", description: "For proprietors, freelancers, and professionals with income from business or profession.", price: "Market ₹1,500–₹2,000 · Member Rate" },
      { name: "ITR-3 Filing (Professional/Business)", href: "/services/itr-3-filing", description: "For individuals and HUFs with detailed business accounts — P&L, balance sheet, and Schedule BP required.", price: "Market ₹2,000–₹5,000 · Member Rate" },
      { name: "ITR-4 Filing (Presumptive Taxation)", href: "/services/itr-4-filing", description: "For small businesses and professionals opting for Section 44AD/44ADA/44AE — simplified presumptive scheme.", price: "Market ₹2,000–₹5,000 · Member Rate" },
      { name: "ITR-5 Filing (LLPs & Partnerships)", href: "/services/itr-5-filing", description: "For partnership firms, LLPs, BOI, AOP — audit linkage and partner capital accounts included.", price: "Market ₹5,000–₹6,500 · Member Rate" },
      { name: "ITR-6 Filing (Companies)", href: "/services/itr-6-filing", description: "For Pvt Ltd, Public Ltd, and other companies — linked to statutory audit and Form 3CB/3CD.", price: "Market ₹2,500–₹13,000 · Member Rate" },
      { name: "ITR-7 Filing (Trusts & NGOs)", href: "/services/itr-7-filing", description: "For charitable trusts, religious institutions, and NGOs claiming exemption under Sections 11 and 12.", price: "Market ₹5,000–₹10,000 · Member Rate" },
    ],
  },
  ...
  // ══════════════════════════════════════════════════
  {
    ...
    relatedLinks: [
      { name: "GST & Indirect Tax", href: "/services/gst-indirect-tax" },
      { name: "Income Tax Advisory", href: "/services/income-tax-advisory" },
      { name: "Financial & Investment", href: "/services/financial-investment" },
    ],
    subServices: [
      { name: "Tax Audit Execution", href: "/services/tax-audit", description: "Section 44AB audit with Form 3CB/3CD filing — complete CA execution from books review to IT portal submission.", price: "Market ₹5,000 · Member Rate" },
      { name: "GST Audit (GSTR-9C)", href: "/services/gst-audit", description: "CA-certified GSTR-9C reconciliation statement for businesses with annual turnover above ₹5 crore.", price: "Market ₹5,000–₹9,999 · Member Rate" },
    ],
  },
  ...
  // ══════════════════════════════════════════════════
  {
    ...
    relatedLinks: [
      { name: "Investment Ready Services", href: "/services/pitch-to-investors" },
      { name: "Audit & Attestation", href: "/services/audit-attestation" },
      { name: "Business Incorporation", href: "/services/business-incorporation" },
    ],
    subServices: [
      { name: "Loan Project Report", href: "/services/loan-project-report", description: "Bank-ready Detailed Project Report with 5-year financials, market analysis, and DSCR ratios.", price: "Market ₹5,000–₹50,000 · Member Rate" },
      { name: "DPIIT / Startup India Recognition", href: "/services/dpiit-recognition", description: "End-to-end application preparation and filing for Startup India recognition certificate.", price: "Market ₹3,000–₹15,000 (consultant) · Member Rate" },
      { name: "Investor Data Room", href: "/services/pitch-to-investors", description: "Secure, access-controlled investor data room with tracking and revocation controls.", price: "Included in subscription" },
    ],
  },
  ...
  // ══════════════════════════════════════════════════
  {
    ...
    relatedLinks: [
      { name: "Business ITR Filing", href: "/services/business-itr-filing" },
      { name: "ITR-3 Filing", href: "/services/itr-3-filing" },
      { name: "Income Tax Advisory", href: "/services/income-tax-advisory" },
      { name: "GST & Indirect Tax", href: "/services/gst-indirect-tax" },
    ],
  },
  ...
  // ══════════════════════════════════════════════════
  {
    ...
    relatedLinks: [
      { name: "ITR-3 Filing (Professional/Business)", href: "/services/itr-3-filing" },
      { name: "ITR-4 Filing (Presumptive)", href: "/services/itr-4-filing" },
      { name: "Salary ITR Filing", href: "/services/salary-itr-filing" },
      { name: "Tax Audit Execution", href: "/services/audit-attestation" },
    ],
  },
  ...
  // ══════════════════════════════════════════════════
  {
    ...
    whatsIncluded: [
      ...
      { title: "Audit certificate linkage", description: "If audit under Section 44AB is applicable, the Form 3CB/3CD report is linked in the ITR-5 filing." },
    ...
    relatedLinks: [
      { name: "LLP Registration", href: "/services/llp-registration" },
      { name: "ITR-6 Filing (Companies)", href: "/services/itr-6-filing" },
      { name: "Tax Audit Execution", href: "/services/audit-attestation" },
      { name: "GST & Indirect Tax", href: "/services/gst-indirect-tax" },
    ],
  },
  ...
  // ══════════════════════════════════════════════════
  {
    ...
    relatedLinks: [
      { name: "ITR-5 Filing (LLPs)", href: "/services/itr-5-filing" },
      { name: "Tax Audit Execution", href: "/services/audit-attestation" },
      { name: "Pvt Ltd Company Incorporation", href: "/services/company-incorporation" },
      { name: "GST & Indirect Tax", href: "/services/gst-indirect-tax" },
    ],
